...
with st.container():
    ...
    with col2: #CONTROLS FOR THE ENTIRE ROW
        ...
        st.markdown('<p class="big-font">Length of Clear Dataset: 1013 Images <br><br>Length of Rainy Dataset: 1054 <br> Images Time to Train: 10:30 Hours</p>', unsafe_allow_html=True)
